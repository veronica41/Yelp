...
+ (NSDictionary *)dictionaryWithFilterOption:(FilterOption *)filterOption {
    ...
    NSMutableDictionary * options = [@{@"term" : filterOption.term, @"location" : filterOption.location, @"cll" : cll, @"radius_filter" : [NSString stringWithFormat:@"%f", filterOption.radiusFilter], @"sort" : [NSString stringWithFormat:@"%d", filterOption.sortFilter], @"deals_filter" : deals} mutableCopy];
